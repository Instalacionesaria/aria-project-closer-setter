...
const SEED: Omit<SetterContact, "historial" | "notas">[] = [
  ...
  {
    name: "CARLA MENDOZA", phone: "34 600 111 222", grade: "B", fuente: "Meta Ads", canal: "whatsapp",
  ...
  {
    name: "JORGE RUIZ", phone: "57 300 999 8888", fuente: "VSL opt-in", canal: "whatsapp",
    stage: "en_calificacion", situacion: "EN CALIFICACIÓN", situacionTone: "cyan",
  ...
  {
    name: "PEDRO SANCHEZ", phone: "54 911 1234 5678", grade: "C", fuente: "Meta Ads", canal: "whatsapp",
  ...
  // Buzón general
  {
    name: "DIEGO SALAZAR", phone: "54 911 2222 3333", fuente: "Meta Ads", canal: "whatsapp",
  ...
  {
    name: "SOFIA NUÑEZ", phone: "54 911 4444 5555", grade: "B", fuente: "VSL opt-in", canal: "whatsapp",
    stage: "en_calificacion", situacion: "EN CALIFICACIÓN", situacionTone: "cyan",
  ...
  {
    name: "MARTINA OYOLA", phone: "54 911 6666 7777", grade: "C", fuente: "📷 IG Profile", canal: "instagram",
    stage: "nurture", situacion: "NURTURE", situacionTone: "violet",
    subtitle: "mensaje sin responder hace 12 min",
    respondido: { microtext: "mensaje sin responder hace 12 min" },
  },
  {
    name: "IGNACIO PRADA", phone: "54 911 8888 9999", grade: "A", fuente: "📷 IG Profile", canal: "instagram",
    stage: "en_calificacion", situacion: "EN CALIFICACIÓN", situacionTone: "cyan",
    subtitle: "mensaje sin responder hace 1h",
    respondido: { microtext: "mensaje sin responder hace 1h" },
  },
  {
    name: "CAMILA ROSSI", phone: "54 911 1122 3344", fuente: "📷 IG Profile", canal: "instagram",
    stage: "low_ticket_ofrecido", situacion: "DERIVADO A LT", situacionTone: "violet",
  ...
  { name: "FERNANDO LOPEZ", phone: "+52 55 4225 6686", grade: "C", fuente: "Meta Ads", canal: "whatsapp",
  ...
  { name: "ELENA MARTIN", phone: "+52 55 9539 7100", grade: "A", fuente: "Meta Ads", canal: "whatsapp",
    stage: "en_calificacion", situacion: "SEGUIMIENTO · PARA DECISIÓN LT", situacionTone: "amber",
    subtitle: "respondió · esperando respuesta", overdue: "Vencido hace 2 días",
    botEstado: "apagado_manual",
    seguimientoPendiente: { microtext: "respondió · esperando respuesta", vencido: true } },
  { name: "MIGUEL RUIZ", phone: "+52 55 5633 4783", grade: "A", fuente: "Meta Ads", canal: "whatsapp",
    stage: "en_calificacion", situacion: "SEGUIMIENTO · PARA AGENDAR", situacionTone: "amber",
    subtitle: "respondió · esperando respuesta", overdue: "Vencido hace 2 días",
    botEstado: "apagado_manual",
    seguimientoPendiente: { microtext: "respondió · esperando respuesta", vencido: true } },
  { name: "PEDRO ALVAREZ", phone: "+52 55 8678 4587", grade: "C", fuente: "Meta Ads", canal: "whatsapp",
    stage: "en_calificacion", situacion: "SEGUIMIENTO · PARA DECISIÓN LT", situacionTone: "amber",
    subtitle: "respondió · esperando respuesta", overdue: "Vencido hace 2 días",
    botEstado: "apagado_manual",
    seguimientoPendiente: { microtext: "respondió · esperando respuesta", vencido: true } },
  { name: "LAURA ALVAREZ", phone: "+52 55 2116 8027", grade: "D", fuente: "Meta Ads", canal: "whatsapp",
    stage: "en_calificacion", situacion: "SEGUIMIENTO · PARA AGENDAR", situacionTone: "amber",
    subtitle: "respondió · esperando respuesta", overdue: "Vencido hace 2 días",
    botEstado: "apagado_manual",
    seguimientoPendiente: { microtext: "respondió · esperando respuesta", vencido: true } },
  { name: "LUIS PEREZ", phone: "+52 55 7484 4190", grade: "B", fuente: "Meta Ads", canal: "whatsapp",
    stage: "en_calificacion", situacion: "SEGUIMIENTO · PARA DECISIÓN LT", situacionTone: "amber",
    subtitle: "respondió · esperando respuesta", overdue: "Vencido hace 2 días",
    botEstado: "apagado_manual",
    seguimientoPendiente: { microtext: "respondió · esperando respuesta", vencido: true } },
  { name: "ELENA ROMERO", phone: "+52 55 3311 2020", grade: "B", fuente: "Meta Ads", canal: "whatsapp",
    stage: "en_calificacion", situacion: "SEGUIMIENTO · PARA AGENDAR", situacionTone: "amber",
    subtitle: "respondió · esperando respuesta", overdue: "Vencido hace 2 días",
    botEstado: "apagado_manual",
    seguimientoPendiente: { microtext: "respondió · esperando respuesta", vencido: true } },
  { name: "PEDRO MARTINEZ", phone: "+52 55 6644 1188", grade: "C", fuente: "Meta Ads", canal: "whatsapp",
    stage: "en_calificacion", situacion: "SEGUIMIENTO · PARA DECISIÓN LT", situacionTone: "amber",
    subtitle: "respondió · esperando respuesta", overdue: "Vencido hace 2 días",
    botEstado: "apagado_manual",
    seguimientoPendiente: { microtext: "respondió · esperando respuesta", vencido: true } },
  {
    name: "RICARDO PAZ", phone: "+52 55 7712 4499", fuente: "Meta Ads", canal: "whatsapp",
  ...
  {
    name: "ANA SILVA", phone: "54 911 4444 5555", grade: "B", fuente: "Meta Ads", canal: "whatsapp",
    stage: "en_calificacion", situacion: "EN CALIFICACIÓN", situacionTone: "cyan",
    subtitle: "preguntó por planes de pago a plazos",
  },
  {
    name: "MATEO DIAZ", phone: "54 911 5555 6666", grade: "C", fuente: "VSL opt-in", canal: "whatsapp",
    stage: "en_calificacion", situacion: "EN CALIFICACIÓN", situacionTone: "cyan",
  ...
  { name: "LUIS GOMEZ", phone: "—", grade: "D", fuente: "Meta Ads", canal: "whatsapp",
    stage: "agendado", situacion: "AGENDADO", situacionTone: "emerald", subtitle: "agendó", agendaFecha: "hace 1 día" },
  { name: "SOFIA SANCHEZ", phone: "—", grade: "B", fuente: "Meta Ads", canal: "whatsapp",
    stage: "agendado", situacion: "AGENDADO", situacionTone: "emerald", subtitle: "agendó", agendaFecha: "hace 1 día" },
];
