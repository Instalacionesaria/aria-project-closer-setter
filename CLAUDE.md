...
| [LISTA-TAGS](docs/migracion/LISTA-TAGS.md)         | **Los 28 tags y 22 custom fields de GHL**: quién escribe cada uno, quién lo lee, y cuáles faltan crear. Vive en `migracion/` porque se transfiere con el paquete                                                 |
